...
CREATE TABLE products (
	...
	is_for_adults BOOLEAN NOT NULL
);
...
('Willard', 'II', 'Sedge', 'Male', 'wsedge1@globo.com', '02.28.2022', 'd59yQr8'),
('Hali', null, 'Oene', 'Non-binary', 'hoene2@mediafire.com', '01.20.2022', 'ZGXW5SK9FMXC'),
('Darcee', 'IV', 'Livsey', 'Non-binary', 'dlivsey3@chronoengine.com', '09.28.2022', 'HjRMeOxa6CB'),
...
('Joyce', null, 'Danev', 'Female', 'jdanev7@wired.com', '10.05.2022', 'JlY6QXnQ0'),
('Aura', 'III', 'Gawthorp', 'Female', 'agawthorp8@ezinearticles.com', '06.11.2022', 'k5Arf3wql6'),
('Hermia', null, 'Grayshan', 'Female', 'hgrayshan9@github.io', '03.08.2022', 'TFItOZTPcZmk'),
...
('Pammie', 'Jr', 'Taberer', 'Female', 'ptabererd@meetup.com', '01.02.2022', 'i1HWVHb'),
('Randie', 'Jr', 'Muehler', 'Female', 'rmuehlere@tamu.edu', '09.06.2022', 'JHSgv9SRKI'),
('Cameron', 'III', 'Southcott', 'Male', 'csouthcottf@hostgator.com', '09.09.2022', 'hMuGY1UYP'),
('Nikolaus', 'IV', 'Tremblet', 'Male', 'ntrembletg@techcrunch.com', '11.08.2022', 'QcE4DY2R'),
('Von', 'Jr', 'Flux', 'Male', 'vfluxh@is.gd', '12.07.2022', 'VfDHisUDwYnJ'),
('Raddy', 'II', 'Gilham', 'Male', 'rgilhami@qq.com', '12.01.2022', 'LGxD0V0uA0qW'),
('Dareen', 'Sr', 'Martina', 'Female', 'dmartinaj@irs.gov', '4.10.2022', 'PogL5tp');
...
('Аватар: Шлях води', 12, 2022, 'AVATAR: THE WAY OF WATER', 'Джеймс Кемерон', 'українська мова', 'Фентезі, Пригоди, Екшн', '3:10', '20th Century Studios, TSG Entertainmentd, Lightstorm Entertainment', 'Джеймс Кемерон, Джош Фрідман, Шейн Салерно', 'Сем Вортінґтон, Зої Салдана, Сіґурні Вівер, Джемейн Клемент, Мішель Єо, Джованні Рібізі, Оона Чаплін, Кліфф Кертіс, Стівен Ленґ та інші.', 'Історія фільму «Аватар: Шлях води» розгортається більше ніж через десятиліття після подій першого фільму. Стрічка розповідає про сім’ю Саллі (Джейка, Нейтірі та їхніх дітей), проблеми, які їх переслідують, шлях, який вони долають, щоб захистити одне одного від небезпек, битви, які вони ведуть, щоб залишитися живими, і трагедії, які вони переживають разом.', 4.9, '3.12.2022', '12.01.2023', 'https://kino-teatr.ua/public/main/films/2022-11/poster_636270ca8b3fc.jpg'),
...
CREATE TYPE eJobTitle AS ENUM ('cinema_director', 'ticket_seller');
...
('Pete', NULL, 'Aizik', 'Male', '2/1/1976', 'paizik9@hexun.com', 'ftJzFDNxXGb', 'product_seller', 1738.48, '09:45', '23:00', '{Sunday, Monday}'::eDayOfWeek[]);
...
INSERT INTO tickets (user_id, session_id, ticket_price) VALUES
(6, 1, 1),
(18, 1, 2);
